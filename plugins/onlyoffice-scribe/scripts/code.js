    ...
    window.Asc.plugin.callCommand(function() {
      ...
      if (_testSelSpec) {
        try {
          ...
          if (_ttgt) {
            // Strip the cell-terminator \t too (a cell's last ¶ reports "text\t"): else
            // @end offset overshoots the run text and _tat() falls back to offset 0.
