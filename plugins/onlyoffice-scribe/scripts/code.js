(function(window, undefined) {
  ...
  function castSelectionGeometry(rect, hasText) {
    castIntent("SELECTION_GEOMETRY", { rect: rect || null, hasText: !!hasText }, true);
  }
