...
### Reproduction / test
Fixture requise : un `.docx` avec un **tableau d'en-tête/pied** ET un tableau du corps **en haut**. Reproductible en **local** (oo-dev, indépendant de la version OO 9.4.0.1 vs 9.4.0-129 — c'est le DOCUMENT). Golden de non-régression à ajouter au harnais selection-cases (les deux sens : ne plus bloquer à tort ; continuer à bloquer les vrais ambigus `hitCount ≥ 1`).
